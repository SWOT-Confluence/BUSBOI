...
#'
#' @param chain integer number of busboi run
...
#'
#' @param chain integer number that indicates busboi run
#' @param nc_out NetCDF file pointer to write to
#' @param discharge list of discharge values
  # write_output(out_data, busboi_output$posteriors, busboi_output$posterior_Q, busboi_output$posterior_Qsd, in_data$valid)
